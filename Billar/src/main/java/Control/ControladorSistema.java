...
public class ControladorSistema {
    ...
    private void configurarListeners() {
        ...
        ventanaAgregar.getBtnGuardar().addActionListener(e -> flujoCreacion());
        ...
        ventanaActualizar.getBtnGuardar().addActionListener(e -> flujoActualizacion());
    ...
    private void flujoCreacion() {
        try {
            ...
            if (nombre.isEmpty() || edadStr.isEmpty() || experienciaStr.isEmpty() || promedioStr.isEmpty()) {
                ventanaAgregar.mostrarError("️ Todos los campos son obligatorios");
                return;
            }
            ...
            if (edad <= 0 || experiencia < 0 || promedio < 0 || promedio > 5) {
                ventanaAgregar.mostrarError("️ Valores inválidos:\n- Edad > 0\n- Experiencia >= 0\n- Promedio entre 0-5");
                return;
            }
    ...
    private void flujoActualizacion() {
        try {
            ...
            if (edad <= 0 || experiencia < 0 || promedio < 0 || promedio > 5) {
                ventanaActualizar.mostrarError("️ Valores inválidos");
                return;
            }
